...
// function pathsToPeak(table, i, j, num = 0, memo = {}) {
//   if (i < 0 || j < 0 || i >= table.length || j >= table[0].length) {
//     return 0;
//   } else if (!memo[[i, j]] && Number(table[i][j]) === 9 && num === 9) {
//     memo[[i, j]] = true;
//     return 1;
//   } else if (Number(table[i][j]) === num) {
//     let newNum = num + 1;
//     return (
//       pathsToPeak(table, i - 1, j, newNum, memo) +
//       pathsToPeak(table, i + 1, j, newNum, memo) +
//       pathsToPeak(table, i, j - 1, newNum, memo) +
//       pathsToPeak(table, i, j + 1, newNum, memo)
//     );
//   } else {
//     return 0;
